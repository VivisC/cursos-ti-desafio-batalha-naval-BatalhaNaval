...
int main(){
    ...
    int octaedro[5][5]; //habilidade octaedro
    ...
    int linha = 4, coluna = 4; //ponto do tabuleiro para a habilidade

    /* a partir daqui e mostrando cada habilidade no tabuleiro!*/
...
//habilidade cone 
    for (int i = 0; i < 5; i++)
    {
        for(int j = 0; j < 5; j++)
        {
            int linhatab = linha + (i - 2);
            int colunatab = coluna + (j - 2);
...
//mostrando o tabuleiro com cone
...
//mostrando o tabuleiro com cruz
...
//mostrando o tabuleiro octaedro
